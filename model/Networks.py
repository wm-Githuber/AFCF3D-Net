...
from model.Decom_Backbone import ResNet3D
...
class Unet3PP(nn.Module):
    def __init__(self, channel):
        ...
        self.reduction0 = Redection3D(r50_ch[0], channel)
        self.reduction1 = Redection3D(r50_ch[1], channel)
        self.reduction2 = Redection3D(r50_ch[2], channel)
        self.reduction3 = Redection3D(r50_ch[3], channel)
        self.reduction4 = Redection3D(r50_ch[4], channel)
